...
class UnsecuredBalance(BaseHeuristic):
    ...
    def analysis(self) -> None:
        ...
        checked_calls = self.memory.reduce_value(
            self.call, "var3", comparator=0, invert=True, inplace=False
        )
        checked_calls = self.memory.reduce_origin(
            checked_calls, "var3", invert=True, inplace=False
        )
