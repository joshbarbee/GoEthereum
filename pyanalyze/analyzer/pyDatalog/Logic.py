...
class Logic(object):
    ...
    def __new__(cls, logic=None):
        if isinstance(logic, cls):
            ...
            Logic.tl.logic.Recursive_Tasks = (
                None  # FIFO queue of tasks for recursive clauses
            )
            Logic.tl.logic.Recursive = (
                False  # True -> process Recursive_tasks. Otherwise, process Tasks
            )
