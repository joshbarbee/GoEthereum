...
def _():
    ...
    move(X19, "1-2,", Y) <= star(X19, 0, 1) & (
        Y == (X2, X1, X3, X4, X5, X6, X7, X8, X9)
    )
    move(X19, "1-4,", Y) <= star(X19, 0, 3) & (
        Y == (X4, X2, X3, X1, X5, X6, X7, X8, X9)
    )

    move(X19, "2-3,", Y) <= star(X19, 1, 2) & (
        Y == (X1, X3, X2, X4, X5, X6, X7, X8, X9)
    )
    move(X19, "2-5,", Y) <= star(X19, 1, 4) & (
        Y == (X1, X5, X3, X4, X2, X6, X7, X8, X9)
    )

    move(X19, "3-6,", Y) <= star(X19, 2, 5) & (
        Y == (X1, X2, X6, X4, X5, X3, X7, X8, X9)
    )

    move(X19, "4-5,", Y) <= star(X19, 3, 4) & (
        Y == (X1, X2, X3, X5, X4, X6, X7, X8, X9)
    )
    move(X19, "4-7,", Y) <= star(X19, 3, 6) & (
        Y == (X1, X2, X3, X7, X5, X6, X4, X8, X9)
    )

    move(X19, "5-6,", Y) <= star(X19, 4, 5) & (
        Y == (X1, X2, X3, X4, X6, X5, X7, X8, X9)
    )
    move(X19, "5-8,", Y) <= star(X19, 4, 7) & (
        Y == (X1, X2, X3, X4, X8, X6, X7, X5, X9)
    )

    move(X19, "6-9,", Y) <= star(X19, 5, 8) & (
        Y == (X1, X2, X3, X4, X5, X9, X7, X8, X6)
    )

    move(X19, "7-8,", Y) <= star(X19, 6, 7) & (
        Y == (X1, X2, X3, X4, X5, X6, X8, X7, X9)
    )
    move(X19, "8-9,", Y) <= star(X19, 7, 8) & (
        Y == (X1, X2, X3, X4, X5, X6, X7, X9, X8)
    )
    ...
    (solution[X, Y] == N) <= (solution[X, Z19] == N1) & move(Z19, N2, Y) & (
        N == N1 + N2
    )
