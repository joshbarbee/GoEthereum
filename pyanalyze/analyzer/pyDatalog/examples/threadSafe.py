...
def queen(thread_name):
    ...
    queens(X0, X1, X2, X3, X4, X5) <= queens(X0, X1, X2, X3, X4) & next_queen(
        X0, X1, X2, X3, X4, X5
    )
    queens(X0, X1, X2, X3, X4, X5, X6) <= queens(X0, X1, X2, X3, X4, X5) & next_queen(
    ...
    next_queen(X0, X1, X2, X3, X4, X5, X6) <= next_queen(X1, X2, X3, X4, X5, X6) & ok(
        X0, 6, X6
    )
    ...
    result = (
        "OK" if len(answers) == [1, 0, 0, 2, 10, 4, 40, 92][n - 1] else "* not OK ! *"
    )
